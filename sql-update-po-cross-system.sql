...
-- UPDATE cosmo_wms_9773.ods_raw_order_po SET receipt_amount = po_amount, split_amount = 0, user_defined2 = 2, user_defined3 = 'htcThanat', user_defined4 = DATE_ADD(NOW(), INTERVAL - 1 HOUR) WHERE raw_order_po_id = '3061177cacb24e46a3361f549a21ba96'; 
-- UPDATE cosmo_wms_9771.ods_raw_order_po SET po_amount = receipt_amount, base_amount = receipt_amount, split_amount = 0, user_defined2 = 2, user_defined3 = 'htcThanat', user_defined4 = DATE_ADD(NOW(), INTERVAL - 1 HOUR) WHERE raw_order_po_id = '3e302803d0f14dedaf81661038d0bf79'; 
